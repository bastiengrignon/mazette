...
const Wave: React.FC<WaveProps> = ({
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 310"
            ...
            className={`absolute top-0 right-0 left-0 w-full h-56 sm:h-auto ${className} ${cssColor ? "" : fillColor}`}>
            ...
            <text className="w-auto" x={900}>
                <textPath alignmentBaseline={textAlignement} xlinkHref="#wave" className="text-3xl"
                    fill={textColor}>
                    {text}
                </textPath>
            </text>
