...
const Home: React.FC = () => (
    <div className="flex flex-col sm:flex-row w-full mt-5 sm:mt-1 md:mt-5 lg:mt-10 page-content">
        <div className="w-full sm:w-2/3">
            <p className="text-base md:text-xl lg:text-2xl px-1 sm:px-4 py-4">
