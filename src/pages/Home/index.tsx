...
const Home: React.FC = () => (
    <div
        ...
        <div className="text-center font-avenirBL">
            <p className="text-3xl sm:text-5xl text-test-red my-1 font-avenirBLO">&#9888; Infos pass sanitaire &#9888;</p>
            <p className="text-base sm:text-xl md:text-3xl border-1 border-test-red font-avenir-BL">
