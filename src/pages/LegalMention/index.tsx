  ...
  <div>
    <div className="h-52 w-full bg-green flex justify-center py-5 px-5 sm:px-0">
      <Link to={RouterUrl.home} title="Retour à l'accueil">
        <Image
          src={`${staticImgFolder}/festival_mazette`}
          alt="Logo Mazette!"
    ...
    <div className="p-10">
      ...
      <p>
        Le site festivalmazette.fr est édité par l’association Mazette!, dont le siège social est situé au 48 rue
        Principale, 49630 Mazé-Milon. <br />
